(function() {
   ...
   const exerciseDB = [
    ...
    { nome: "Pull Up", nivel: "Iniciante", grupo_principal: "Costas", grupos_secundarios: ["Bíceps", "Antebraço"], tipo: "Pull", xp: 20, duracao: 45, gif: "https://i.pinimg.com/originals/6a/48/f2/6a48f2ce2ed77de80e7e139036638cf2.gif" },
    { nome: "Chin Up", nivel: "Iniciante", grupo_principal: "Bíceps", grupos_secundarios: ["Dorsal", "Core"], tipo: "Pull", xp: 20, duracao: 45, gif: "https://hips.hearstapps.com/hmg-prod/images/workouts/2016/03/chinup-1457101678.gif?crop=1xw:1xh;center,top&resize=980:*" },
    { nome: "Archer Pull Up", nivel: "Intermediário", grupo_principal: "Costas", grupos_secundarios: ["Bíceps", "Ombro"], tipo: "Pull", xp: 35, duracao: 45, gif: "https://media.giphy.com/media/MAoPEuidcfXxprfkNZ/giphy.gif" },
    { nome: "Typewriter Pull Up", nivel: "Intermediário", grupo_principal: "Costas", grupos_secundarios: ["Bíceps", "Core"], tipo: "Pull", xp: 35, duracao: 45, gif: "https://i.makeagif.com/media/6-21-2026/aOVWQN.gif" },
